...
<br/>
The later, sometimes also called public key crytography, is far more important and widely usued in computer security. It uses pairs of related keys, and each key pair consists of a public key and a corresponding private key, generated with one-way(trapdoor) functions. The concepts behind these can be tremendously difficult math problems often related to number theory.
